<?php
/* @var $this FuncionProductoController */
/* @var $model FuncionProducto */
...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'Funcion_id'); ?>
		<?php echo $form->error($model,'Funcion_id'); ?>
	</div>
