...
class NotaIngresoController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['NotaIngreso'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('NotaIngreso');
	...
	{
		$model=new NotaIngreso('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['NotaIngreso']))
			$model->attributes=$_GET['NotaIngreso'];
	...
	{
		$model=NotaIngreso::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param NotaIngreso $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='nota-ingreso-form')
		{
